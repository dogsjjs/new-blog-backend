...
export default {
    ...
    dataSource: {
      default: {
        ...
        entities: [
          ...
          User,
          Post,
          /* 其他实体可以放在这里 */ join(__dirname, '../entity/**/*.ts'),
        ], // 添加 Post 实体
  ...
  jwt: {
    secret:
      process.env.JWT_SECRET || 'your-very-secure-and-long-secret-key-for-jwt', // 强烈建议使用环境变量
    expiresIn: '1d', // Token 有效期，例如 1 天
  },
  ...
  crossDomain: {
    ...
    origin: (ctx: any) => {
      ...
      return (
        process.env.ALLOWED_ORIGIN || 'https://your-production-frontend.com'
      ); // 生产环境应配置具体的域名
    },
